        ...
        inquirer.prompt([
            {
                ...
                // maybe make a list that calls the id's like const (the emp_id = #) and then it calls the correct part of the table instead of a random name? or was this working so why bother
            },
            {
                type: 'list',
                name: 'role',
